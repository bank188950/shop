...
export function LocationTable() {
  ...
  async function deleteLocation(locationId: number, locationName: string) {
    ...
    setPage((currentPage) => Math.min(currentPage, Math.max(1, Math.ceil(nextLocations.length / pageSize))))
