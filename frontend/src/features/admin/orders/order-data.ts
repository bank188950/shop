...
export const orderListStatuses = ['รอชำระเงิน', 'รอตรวจสอบ', 'เตรียมสินค้า', 'กำลังส่ง', 'ส่งแล้ว', 'ยกเลิก'] as const
...
export const mockOrders: AdminOrder[] = [
  ...
  { id: 'ORD-200720-08', orderedAt: '20 ก.ค. 2569 11:46', deliveryDate: '2026-07-20', period: 'afternoon', location: 'จุดรับสินค้า A', customerName: 'คุณนิด', phone: '0867778899', lineId: '@nid_day', items: [{ name: 'น้ำเก๊กฮวยเย็น', quantity: 3, unit: 'แก้ว', unitPrice: 25 }, { name: 'ลูกชิ้นเนื้อเอ็น', quantity: 2, unit: 'ไม้', unitPrice: 20 }], paymentStatus: 'จ่ายแล้ว', status: 'ส่งแล้ว' },
  { id: 'ORD-200720-09', orderedAt: '20 ก.ค. 2569 12:05', deliveryDate: '2026-07-20', period: 'afternoon', location: 'จุดรับสินค้า B', customerName: 'คุณจอย', phone: '0831112233', lineId: '@joy_snack', items: [{ name: 'ลูกชิ้นหมูพรีเมียม', quantity: 5, unit: 'ไม้', unitPrice: 15 }, { name: 'น้ำเก๊กฮวยเย็น', quantity: 2, unit: 'แก้ว', unitPrice: 25 }], paymentStatus: 'รอชำระเงิน', status: 'รอชำระเงิน' },
  { id: 'ORD-200720-10', orderedAt: '20 ก.ค. 2569 12:22', deliveryDate: '2026-07-20', period: 'afternoon', location: 'จุดรับสินค้า C', customerName: 'คุณอาร์ต', phone: '0876665544', lineId: '@art_grill', items: [{ name: 'ไส้กรอกอีสานย่าง', quantity: 6, unit: 'ไม้', unitPrice: 15 }], paymentStatus: 'จ่ายแล้ว', status: 'กำลังส่ง' },
]
...
export function statusClass(status: OrderStatus | PaymentStatus) {
  ...
  if (status === 'กำลังส่ง') return 'delivering'
  if (status === 'รอตรวจสอบ' || status === 'เตรียมสินค้า') return 'preparing'
  return 'success'
}
