...
export type OrderStatus = 'รอชำระเงิน' | 'จ่ายแล้ว' | 'เตรียมของ' | 'ออกส่งแล้ว' | 'ส่งแล้ว' | 'ยกเลิก'
