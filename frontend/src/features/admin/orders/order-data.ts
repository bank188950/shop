...
export const mockOrders: AdminOrder[] = [
  ...
  { id: 'PO-200720-10', orderedAt: '20 ก.ค. 2569 12:22', deliveryDate: '2026-07-20', period: 'afternoon', location: 'จุดรับสินค้า C', customerName: 'คุณอาร์ต', phone: '0876665544', lineId: '@art_grill', items: [{ name: 'ไส้กรอกอีสานย่าง', quantity: 6, unit: 'ไม้', unitPrice: 15 }], paymentStatus: 'จ่ายแล้ว', status: 'กำลังส่ง' },
]
