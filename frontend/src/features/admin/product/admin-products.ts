...
export const adminProducts: AdminProduct[] = [
  ...
  { id: 2, name: 'ไส้กรอกอีสานย่าง', detail: 'ไม้ละ 2 ชิ้น', category: 'ไส้กรอก', price: 20, pieceCount: 90, piecesPerStick: 2, unit: 'ไม้', stock: '45 ไม้', lowStockThreshold: 5, status: 'สต็อกต่ำ', isActive: true, image: '/images/product-isan-sausage.png' },
  ...
  { id: 4, name: 'ลูกชิ้นเนื้อเอ็น', detail: 'ไม้ละ 3 ลูก', category: 'ลูกชิ้น', price: 20, pieceCount: 180, piecesPerStick: 3, unit: 'ไม้', stock: '60 ไม้', lowStockThreshold: 5, status: 'พร้อมขาย', isActive: true, image: '/images/product-pork-premium.png' },
]
