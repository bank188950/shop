import { ChevronLeft, ChevronRight, CircleAlert, PackagePlus, Pencil, ShoppingBasket, TrendingUp, TriangleAlert } from 'lucide-react'
...
export function ProductTable() {
  return <section className="admin-page product-page">
    <div className="admin-page-heading"><div><p className="admin-kicker">คลังสินค้า</p><h1 className="admin-title">สินค้า</h1></div><Link to="/admin/products/new" className="admin-primary-button"><PackagePlus size={19} />เพิ่มสินค้า</Link></div>
