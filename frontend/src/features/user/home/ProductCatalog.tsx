...
export function ProductCatalog() {
  ...
  // กันหน้าค้างเกินจำนวนจริง เช่นสลับไปหมวดที่มีเมนูน้อยกว่าหน้าที่เปิดอยู่
  ...
  return (
    <section id="menu" className="px-1 pt-8 pb-6 max-md:px-0.5 max-md:pt-8" aria-labelledby="menu-heading">
      ...
      <StorefrontPagination currentPage={currentPage} totalItems={products.length} pageSize={pageSize} onPageChange={setPage} label="เมนู" />
    </section>
  )
}
