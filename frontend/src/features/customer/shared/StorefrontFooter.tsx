export function StorefrontFooter() {
  return (
    <footer className="mt-9 grid justify-items-center gap-5 bg-[#0d6b1c] px-6 py-[42px] pb-[50px] text-center text-[#f5f5e8]">
      <a className="inline-flex items-center gap-2.5 text-inherit no-underline" href="#top" aria-label="ลูกชิ้นล้อเลื่อน กลับด้านบน">
        <img className="size-[46px] object-contain" src="/images/logo-white.png" alt="โลโกลูกชิ้นล้อเลื่อน" />
        <strong className="font-heading text-xl">ลูกชิ้นล้อเลื่อน</strong>
      </a>
      ...
      <p className="m-0 text-lg text-[#c8dfc4]">© 2026 ลูกชิ้นล้อเลื่อน - By Tawatchai</p>
    </footer>
  )
}
