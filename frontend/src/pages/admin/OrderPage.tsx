...
export function OrderPage() {
  ...
  const orders = useMemo(() => sortOrdersNewestFirst(ordersData.filter((order) => (
    ...
    && `${order.id} ${order.userName}`.toLowerCase().includes(query.toLowerCase())
