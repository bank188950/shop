...
export type AdminUser = { id: number, name: string, phone: string, lineId: string, locationId: number | null, locationName: string, isActive: boolean, messageCount: number }
export type UserSaveInput = Omit<AdminUser, 'id' | 'locationName' | 'messageCount'> & { password: string, confirmPassword: string }
