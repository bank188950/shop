...
export const products: Product[] = [
  { id: 5, name: 'ข้าวผัดกุ้ง', stockLabel: 'เหลือ 12 จาน', price: 45, badge: 'มีสินค้า', isRecommended: true, status: 'in-stock', image: '/images/product-shrimp-fried-rice.png', description: 'ข้าวผัดกุ้งหอมกระทะ ผัดไข่และผักรวม เสิร์ฟพร้อมแตงกวาและมะนาว สดใหม่ทุกจาน' },
