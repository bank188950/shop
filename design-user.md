...
7. **Footer** — footer สีเขียวเข้มเต็มความกว้าง จัดเนื้อหากึ่งกลาง แสดงโลโก้สีขาว ชื่อแบรนด์ ลิงก์ช่วงเวลาจัดส่ง และ `© 2026 ลูกชิ้นล้อเลื่อน - By Tawatchai`
...
- ปุ่มสรุปรายการสั่งซื้อนำไปยังหน้า `/order-summary`; ปุ่มยืนยันบนหน้านั้นยังไม่มี checkout handler
