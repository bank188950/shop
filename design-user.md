...
7. **Sticky cart** — แถบลอยสีเขียวเข้มใกล้ขอบล่างของ viewport กว้างสูงสุด 1440px แสดงจำนวนสินค้าและยอดรวม พร้อมปุ่ม `ดูรายการสั่งซื้อ` สีน้ำตาล ปุ่มจะ disabled เมื่อตะกร้าว่างโดยยังคงพื้นผิวสีน้ำตาลแบบลด contrast และนำผู้ใช้ไปที่ `/order-summary` เมื่อตะกร้ามีสินค้า ตะกร้าที่ persist จะเริ่มต้นด้วยไส้กรอกอีสานย่าง 1 รายการ
