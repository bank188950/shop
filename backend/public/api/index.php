...
require_once dirname(__DIR__, 2) . '/src/shared/promptpay.php';
require_once dirname(__DIR__, 2) . '/src/shared/slip2go.php';
...
require_once dirname(__DIR__, 2) . '/src/user/orders/payment.php';
